        ...
        >
          ...
          <el-table-column label="属性值">
            ...
            <template v-slot="{ row, $index }">
              <div v-if="row.edit_tolook" @click="edit_handler(row, $index)">
                {{ row.valueName }}
              </div>
          ...
          <el-table-column label="操作">
            <template v-slot="{ $index }">
              ...
              <el-button
                size="small"
                type="primary"
                @click="attr_data_params.attrValueList.splice($index, 1)"
                icon="Delete"
              ></el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-button type="primary" @click="save_btn_handler">保存</el-button>
        <el-button type="primary" @click="cancel_btn_handler">取消</el-button>
      </div>
    </el-card>
  </div>
</template>
