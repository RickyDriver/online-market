      ...
      >
        ...
        >
          ...
          <el-form-item label="品牌LOGO:" prop="logoUrl" label-width="100px">
            ...
            >
              <div class="img-box" v-if="trademark_parmas.logoUrl">
                <el-image :src="trademark_parmas.logoUrl" fit="fill"></el-image>
              </div>
...
const delete_trademark = async (id: number) => {
  ...
  if (res.code == 200) {
    ...
    get_has_trademark(
      trademark_arr.value.length > 1 ? page_num.value : page_num.value - 1,
    )
  } else {
    ElMessage({
      type: 'error',
