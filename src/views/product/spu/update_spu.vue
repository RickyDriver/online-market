  ...
  <div>
    <el-card>
      <el-form label-width="120px">
        ...
        <el-form-item label="SPU销售属性" :prop="spu_store.all_trade_mark">
          <el-select
        ...
        <el-form-item>
          <el-button type="primary" @click="comfirm_change">确认</el-button>
          <el-button type="primary" @click="cancel_handler">取消</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
